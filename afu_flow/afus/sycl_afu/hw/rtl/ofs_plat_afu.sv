...
module ofs_plat_afu
   (
    ...
    //   // AVS kernel_cra
    //   kernel_cra_debugaccess    ( ? ),  // input logic 
    //   kernel_cra_burstcount     ( csr_mmio64_to_afu.burstcount ),   // input logic 
    //   kernel_cra_enable         ( ? ),   // input logic 
    ...
    //   kernel_cra_writedata      ( csr_mmio64_to_afu.writedata  ),  // input logic [63:0] 
    //   kernel_cra_byteenable     ( csr_mmio64_to_afu.byteenable ),   // input logic [7:0] 
    //   kernel_cra_waitrequest    ( csr_mmio64_to_afu.waitrequest ),  // output logic 
    //   kernel_cra_readdata       ( csr_mmio64_to_afu.readdata ),   // output logic [63:0] 
    //   kernel_cra_readdatavalid  ( csr_mmio64_to_afu.readdatavalid ),  // output logic 
    //   // TODO: intercept and trigget AVMM writes with ofs_plat_host_chan_avalon_mem_pkg::HC_AVALON_UFLAG_INTERRUPT, see bsp_host_mem_if_mux
    //   .kernel_irqs              ( /* TBD */ ),   // output logic 
