...
#define KERNEL_START                    (ZTS14SYCLLOOPBACKID_REGISTER_MAP_START_REG)                // Start the kernel, don't read in ASE! 
...
// Values
#define KERNEL_START_VALUE              ((uint32_t)1u) // This must be 32-bits long
