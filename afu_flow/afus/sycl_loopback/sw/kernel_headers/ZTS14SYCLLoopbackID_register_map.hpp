...
/* This header file describes the Register Map for the ZTS14SYCLLoopbackID kernel */
...
#ifndef __ZTS14SYCLLOOPBACKID_REGISTER_MAP_REGS_H__
#define __ZTS14SYCLLOOPBACKID_REGISTER_MAP_REGS_H__
...
---------|--------|--------------|-------------------------------------|-------------------------------
    0x90 |      W |  reg18[63:0] |              arg_length_lines[63:0] |                              
*/
...
/* Byte Addresses */
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_STATUS_REG (0x0 + ZTS14SYCLLOOPBACKID_REGISTER_MAP_OFFSET)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_START_REG (0x8 + ZTS14SYCLLOOPBACKID_REGISTER_MAP_OFFSET)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_FINISHCOUNTER_REG (0x30 + ZTS14SYCLLOOPBACKID_REGISTER_MAP_OFFSET)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_FINISHCOUNTER_REG (0x30 + ZTS14SYCLLOOPBACKID_REGISTER_MAP_OFFSET)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_DEVICE_READ_REG (0x80 + ZTS14SYCLLOOPBACKID_REGISTER_MAP_OFFSET)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_DEVICE_WRITE_REG (0x88 + ZTS14SYCLLOOPBACKID_REGISTER_MAP_OFFSET)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_LENGTH_LINES_REG (0x90 + ZTS14SYCLLOOPBACKID_REGISTER_MAP_OFFSET)

/* Argument Sizes (bytes) */
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_DEVICE_READ_SIZE (8)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_DEVICE_WRITE_SIZE (8)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_LENGTH_LINES_SIZE (8)

/* Argument Masks */
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_DEVICE_READ_MASK (0xffffffffffffffffULL)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_DEVICE_WRITE_MASK (0xffffffffffffffffULL)
#define ZTS14SYCLLOOPBACKID_REGISTER_MAP_ARG_ARG_LENGTH_LINES_MASK (0xffffffffffffffffULL)

#endif /* __ZTS14SYCLLOOPBACKID_REGISTER_MAP_REGS_H__ */
