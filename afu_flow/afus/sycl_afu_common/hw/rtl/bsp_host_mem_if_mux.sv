...
module bsp_host_mem_if_mux # (
        // Override signal width, instead of importing from dc_bsp_pkg
        localparam BSP_NUM_INTERRUPT_LINES = 1
    ) ( 
    input logic clk,
    input logic reset,
...
always_ff @(posedge clk) begin
    ...
    // (vlog-2121) Illegal concatenation of an unsized constant.
...
// Only supporting one irq from AFU
assign pending_irq_id = 2'b00;
