...
help: # TBD
	...
	# @echo "	ase_setup			first setup and launch of simulation environment after RTL build {locks a terminal}"
	# @echo "	ase_launch			subsequent launches of simulator {locks a terminal}"
	...
	# @echo "	test_ase			run host application against ASE simulator"
	# @echo "						{requires ${MAKE} ase_setup or ${MAKE} ase_launch in another terminal}"
	# @echo "	clean_oneapi		clean oneapi build"
	# @echo "	clean_gbs			clean synthesis"
	# @echo "	clean_ase			clean simulator setup"
