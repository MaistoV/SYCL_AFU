...
> NOTE: **This needs further exploration.**

> For now leave this at this is, a simple workaround would be to instantiate a `null_afu` in that position so save hardware, by the switching logic would still be there.
