...
if [ $SRIOV_NUMVF == "0" ]; then
    ...
    #   HE-MEM Stub     XXXX:XX:XX.6 	56e203e9-864f-49a7-b94b-12284c31e02b
    #   ??              XXXX:XX:XX.1 	1aae155c-acc5-4210-b9ab-efbd90b970c4
...
# Export VF numbers
export PCIE_SBD=0000:01:00
export PCIE_HEM_MEM=$PCIE_SBD.5
export PCIE_HEM_LPBK=$PCIE_SBD.2
export PCIE_HEM_LPBK_bis=$PCIE_SBD.6
export PCIE_HEM_MEM_TG=$PCIE_SBD.7
