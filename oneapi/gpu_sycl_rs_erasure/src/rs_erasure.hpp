...
#define LINE_BIT_WIDTH 				64U				// Width of interface in bits
#define LINE_BYTE_WIDTH 			(LINE_BIT_WIDTH/8) 	// Width of interface in bytes
#define LOG2_LINE_BYTE_WIDTH		3u					// log2(CELL_BYTE_WIDTH) = log2(64)
...
#define CELL_LENGTH_MIN 		(LINE_BYTE_WIDTH)	// MIN (by design)
	...
	#define CELL_LENGTH_DEFAULT (CELL_LENGTH_MIN)	// Length of RS cell in bytes
#endif
